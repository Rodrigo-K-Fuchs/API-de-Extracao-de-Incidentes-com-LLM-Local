...
2. Text goes through deterministic preprocessing
3. Processed text is sent to the local LLM (Ollama)
4. LLM output is validated with Pydantic
...
- [Git](https://git-scm.com/downloads) or [GitHub CLI](https://cli.github.com/) *(to clone the repository)*
